  ...
  return (
    <div className='flex flex-col w-1/2 mx-auto text-zinc-50  items-center p-10 pt-28'>
        ...
        <label>
            ...
            type="name" name="name" id="name" placeholder='Enter name' required/>
          </label>
          <label>
          ...
          <label>
            ...
            <input onChange={changeHandler}
            className='border-2 border-zinc-100 p-1 rounded-md w-full mt-1'
            type="confirmPassword" name="confirmPassword" placeholder='Confirm Password' required/>
          </label>

          <button className='px-6 py-2 bg-zinc-900 rounded-md text-zinc-50 font-semibold my-4 cursor-pointer hover:bg-zinc-800'>Signup</button>
